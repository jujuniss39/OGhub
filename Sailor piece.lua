...
local hasJoinedDiscord = "fuck taolao_DiscordJoined.txt"
...
local function PostToWebhook()
    ...
    local payload = {
        ["embeds"] = {{
            ...
            ["footer"] = { ["text"] = string.format("fuck taolao â€¢ Session: %s â€¢ %s", GetSessionTime(), os.date("%x %X")) },
...
local function SendSafetyWebhook(targetPlayer, reason)
    ...
    local payload = {
        ["embeds"] = {{
            ...
            ["footer"] = { ["text"] = "fuck taolao â€¢ " .. os.date("%x %X") }
        }}
    }
...
local Window = Library:CreateWindow({
	Title = "fuck taolao",
	Footer = "" .. assetName .. " | DUMPED | FUCK YOU",
	NotifySide = "Right",
